...
public class CustomListView extends ListView implements OnScrollListener {
	...
	private void init(Context context) {
        ...
        loadMoreButton.setOnClickListener(new MyOnClickListener());
	...
	public void onRefreshComplete() {
		...
		lastUpdatedTextView.setText("最近更新:" + StringUtils.friendly_time(date));
		changeHeaderViewByState();
	}
	...
	public void setAdapter(ListAdapter adapter,Handler handler) {
	...
	public void setButtonClickable(boolean isClick){
		loadMoreButton.setClickable(isClick);
	}
